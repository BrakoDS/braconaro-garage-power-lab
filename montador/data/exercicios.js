...
export const EXERCICIOS = [
  ...
  },
  {
    ...
    padrao: 'empurrar', musculosPrimarios: ['peito'], musculosSecundarios: ['triceps', 'ombro'],
    categorias: ['hipertrofia', 'forca'], equipamento: ['halter', 'banco'],
    nivel: 'iniciante', tempoMedioSeg: 35,
  },
  {
  ...
  {
    id: 'crucifixo_inclinado_halter', nome: 'Crucifixo inclinado (halteres)',
  ...
  {
    id: 'crossover_polia', nome: 'Crossover na polia',
    descricao: 'Em pé entre as polias, cruzar os braços à frente — tensão constante, dá pra variar a altura.',
    padrao: 'empurrar', musculosPrimarios: ['peito'], musculosSecundarios: [],
  ...
  {
    id: 'triceps_testa_polia', nome: 'Tríceps testa na polia',
    descricao: 'Deitado/inclinado, estender a barra da polia sobre a testa — tensão constante do cabo.',
    padrao: 'empurrar', musculosPrimarios: ['triceps'], musculosSecundarios: [],
    categorias: ['hipertrofia'], equipamento: ['monocross'],
    nivel: 'intermediario', tempoMedioSeg: 30, multiarticular: false,
  },
  ...
  {
    id: 'triceps_frances_halter', nome: 'Tríceps francês (halter)',
  ...
  {
    id: 'triceps_coice_halter', nome: 'Tríceps coice (kickback, halteres)',
  ...
  {
    id: 'puxada_braco_estendido', nome: 'Puxada com braço estendido (polia)',
  ...
  },
  {
    ...
    categorias: ['hipertrofia'], equipamento: ['barra_livre'],
    nivel: 'iniciante', tempoMedioSeg: 30, multiarticular: false,
  },
  {
    id: 'rosca_martelo', nome: 'Rosca martelo (halteres)',
  ...
  {
    id: 'rosca_polia', nome: 'Rosca na polia (monocross)',
    descricao: 'Barra/corda na polia baixa, flexionar mantendo tensão constante do cabo.',
    padrao: 'puxar', musculosPrimarios: ['biceps'], musculosSecundarios: [],
    categorias: ['hipertrofia'], equipamento: ['monocross'],
    nivel: 'iniciante', tempoMedioSeg: 30, multiarticular: false,
  },
