...
node --test $(ls coach/montador-de-treino/core/*.test.js coach/montador-de-treino/ui/*.test.js coach/montador-de-treino/config/*.test.js painel-do-aluno/*.test.js compartilhado/regras/*.test.js garage-store/*.test.js coach/academia/*.test.js coach/academia/data/*.test.js)
